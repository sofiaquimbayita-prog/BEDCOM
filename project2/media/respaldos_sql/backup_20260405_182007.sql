...
CREATE TABLE `calendario` (
  ...
  `modo_completado` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `categorias` VALUES (1,'jghgj','trytrytrrtyrtyrtytryrty','producto',1),(2,'tretreter','ertertertret','insumo',1);
...
CREATE TABLE `despacho` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `fecha` date NOT NULL,
  `estado_entrega` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `django_migrations` VALUES (1,'contenttypes','0001_initial','2026-04-05 23:15:03.398339'),(2,'contenttypes','0002_remove_content_type_name','2026-04-05 23:15:03.509055'),(3,'auth','0001_initial','2026-04-05 23:15:03.862914'),(4,'auth','0002_alter_permission_name_max_length','2026-04-05 23:15:03.946456'),(5,'auth','0003_alter_user_email_max_length','2026-04-05 23:15:03.955651'),(6,'auth','0004_alter_user_username_opts','2026-04-05 23:15:03.964636'),(7,'auth','0005_alter_user_last_login_null','2026-04-05 23:15:03.975647'),(8,'auth','0006_require_contenttypes_0002','2026-04-05 23:15:03.979920'),(9,'auth','0007_alter_validators_add_error_messages','2026-04-05 23:15:03.991330'),(10,'auth','0008_alter_user_username_max_length','2026-04-05 23:15:04.001873'),(11,'auth','0009_alter_user_last_name_max_length','2026-04-05 23:15:04.011241'),(12,'auth','0010_alter_group_name_max_length','2026-04-05 23:15:04.054038'),(13,'auth','0011_update_proxy_permissions','2026-04-05 23:15:04.073115'),(14,'auth','0012_alter_user_first_name_max_length','2026-04-05 23:15:04.090300'),(15,'app','0001_initial','2026-04-05 23:15:07.663599'),(16,'admin','0001_initial','2026-04-05 23:15:07.903847'),(17,'admin','0002_logentry_remove_auto_add','2026-04-05 23:15:07.920713'),(18,'admin','0003_logentry_add_action_flag_choices','2026-04-05 23:15:07.938804'),(19,'axes','0001_initial','2026-04-05 23:15:08.015442'),(20,'axes','0002_auto_20151217_2044','2026-04-05 23:15:08.261848'),(21,'axes','0003_auto_20160322_0929','2026-04-05 23:15:08.289758'),(22,'axes','0004_auto_20181024_1538','2026-04-05 23:15:08.316337'),(23,'axes','0005_remove_accessattempt_trusted','2026-04-05 23:15:08.391334'),(24,'axes','0006_remove_accesslog_trusted','2026-04-05 23:15:08.468835'),(25,'axes','0007_alter_accessattempt_unique_together','2026-04-05 23:15:08.535505'),(26,'axes','0008_accessfailurelog','2026-04-05 23:15:08.680492'),(27,'axes','0009_add_session_hash','2026-04-05 23:15:08.767526'),(28,'axes','0010_accessattemptexpiration','2026-04-05 23:15:08.879233'),(29,'sessions','0001_initial','2026-04-05 23:15:08.940854'),(30,'usuarios','0001_initial','2026-04-05 23:15:09.111101');
...
INSERT INTO `django_session` VALUES ('qnjffmee1pb90abyq4mnjddh9ybi4ee7','.eJxVi0sKwzAMRO_idQmxHVtSl4Wew0hWjEM_hLpZld49CWTRbgbevJmPSby8a1ra-EqTmrOx5vTbCefb-NwFz3N3UOuuD57ul8P9HSq3uq0HgswlOkUUjy44gOhFIIeC0Fu05HBQ5S1JikZiLEG1j8VrJszmuwLx5jGU:1w9WhQ:T8u7Dh-NvAmohJLIT5CkYHBGev7Fiz64_OSG3Jwa9nU','2026-04-19 23:16:12.164056');
...
INSERT INTO `entrada` VALUES (1,'2026-04-05 23:20:00.812346',3,4.00,12.00,'werwe',1,0,1,1,NULL);
...
CREATE TABLE `historial_acciones` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `fecha` datetime(6) NOT NULL,
  `tipo_accion` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `historial_acciones` VALUES (1,'2026-04-05 23:17:53.410881','crear','productos','CreÃ³ el producto \"Barniz mat\"',NULL,NULL,1),(2,'2026-04-05 23:19:48.969335','crear','salidas','RegistrÃ³ salida de 1 un. de \"Barniz mat\" (motivo: ventas)',NULL,NULL,1),(3,'2026-04-05 23:20:00.815376','crear','entradas','RegistrÃ³ entrada de 3 un. de \"Barniz mat\"',NULL,NULL,1);
...
INSERT INTO `insumo` VALUES (1,'erterterter','',3,'lb',35.00,'Activo',2,1);
...
CREATE TABLE `notificaciones` (
  ...
  `relacionada_tipo` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `productos` VALUES (1,'Barniz mat','fdgdfgdffffffffffffffffffffffffffffffffffff',43534.00,345347,'',1,1);
...
INSERT INTO `proveedor` VALUES (1,'distribuidora','3453453453','34534tgfrg34534534','',1);
...
CREATE TABLE `respaldos` (
  ...
  `tipo_respaldo` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` longtext COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `salida_producto` VALUES (1,1,'2026-04-05','ventas','luis',1,1);
...
INSERT INTO `usuarios` VALUES (1,'pbkdf2_sha256$1200000$hiUjqqmUkEb6lB8PzNkBMR$7sqipTbVhE5nYGzuyE4ph0Wwl/rOMTChnjrL9Z9QaMs=','2026-04-05 23:16:12.158595',1,'luis','','',1,1,'2026-04-05 23:15:52.061332','123456','administrador','Activo','',NULL,'luis@gmail.com');
...
-- Dump completed on 2026-04-05 18:20:07
