# Generated by Django 6.0.4 on 2026-05-03 23:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tipo",
                    models.CharField(
                        choices=[("producto", "Producto"), ("insumo", "Insumo")],
                        default="producto",
                        max_length=20,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "es_especial",
                    models.BooleanField(
                        default=False, verbose_name="Cliente Especial (Plazo extendido)"
                    ),
                ),
                ("estado", models.BooleanField(default=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "imagen",
                    models.ImageField(blank=True, null=True, upload_to="proveedores/"),
                ),
                ("estado", models.BooleanField(default=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id_proveedor",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="app.proveedor"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id_garantia",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="app.garantia"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "es_personalizado",
                    models.BooleanField(default=False, verbose_name="Es personalizado"),
                ),
                (
                    "especificaciones",
                    models.TextField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True, help_text="ID del modelo relacionado", null=True
                    ),
                ),
                (
                    "data_json",
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text="Datos extra: {producto_id:1, stock:3}",
                    ),
                ),
                (
                    "user",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["leida", "fecha_notif"],
                        name="notificacio_leida_3ab474_idx",
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "insumo",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="app.insumo"
                    ),
                ),
                (
                    "producto",
