...
from .views.respaldos import views as respaldos #linea nueva para acceder a las vistas de respaldos
...
urlpatterns = [
   ...
   # --- PROVEEDORES ---
      ...
      # --- RESPALDOS ---
      path('respaldos/', backup, name='respaldos_list'),
      ...
      path('restaurar-datos/', respaldos.RestaurarDatosView.as_view(), name='restaurar_datos'),
