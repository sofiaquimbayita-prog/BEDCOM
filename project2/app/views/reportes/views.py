...
class ReporteVentasView(View):
    """
    Vista basada en clases para el reporte de ventas
    Muestra estadísticas de ventas, productos top, gráficos y más
    """
    
    def get(self, request):
        # 1. TOTAL VENTAS (Todos los tiempos - Sin filtro de fecha)
        ...
        # 5. CÁLCULO DE UTILIDAD Y MARGEN (Basado en todos los tiempos)
        utilidad_neta = float(total_ventas) - total_gastos_acumulados
...
# Mantenemos la función para compatibilidad hacia atrás (deprecated)
