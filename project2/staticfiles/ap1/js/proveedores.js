...
function actualizarTabla() {
    ...
    $.ajax({
        ...
        error: function(xhr, status, error) {
            ...
            window.showToast('No se pudieron cargar los proveedores', 'error');
        }
    });
}
...
function verProveedor(id) {
    $.ajax({
        ...
        error: function(xhr, status, error) {
            ...
            window.showToast('No se pudo cargar el proveedor', 'error');
        }
    });
}
...
function confirmarEliminar() {
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                window.showToast('Proveedor desactivado correctamente', 'success');
            } else {
                window.showToast(response.message || 'No se pudo desactivar el proveedor', 'error');
            }
        ...
        error: function(xhr, status, error) {
            ...
            window.showToast('No se pudo desactivar el proveedor', 'error');
        }
    });
}
...
function confirmarActivar() {
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                window.showToast('Proveedor activado correctamente', 'success');
            } else {
                window.showToast(response.message || 'No se pudo activar el proveedor', 'error');
            }
        ...
        error: function(xhr, status, error) {
            ...
            window.showToast('No se pudo activar el proveedor', 'error');
        }
    });
}
    ...
    $('#formAgregarProveedor').on('submit', function(e) {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                window.showToast('No se pudo guardar el proveedor', 'error');
            }
        });
    ...
    $('#formEditarProveedor').on('submit', function(e) {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                window.showToast('No se pudo actualizar el proveedor', 'error');
            }
        });
